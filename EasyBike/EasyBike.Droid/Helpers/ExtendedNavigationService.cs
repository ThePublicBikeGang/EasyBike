...
namespace EasyBike.Droid.Helpers
{
    ...
    public class ExtendedNavigationService : INavigationService
    {
        ...
        public string CurrentPageKey
        {
            get
            {
                return ActivityBaseEx.CurrentActivity.ActivityKey ?? RootPageKey;
            }
        }
        ...
        {
            if (ActivityBaseEx.CurrentActivity == null)
            {
            ...
            lock (_pagesByKey)
            {
                ...
                var intent = new Intent(ActivityBaseEx.CurrentActivity, _pagesByKey[pageKey]);
                ...
                ActivityBaseEx.CurrentActivity.StartActivity(intent);
                ActivityBaseEx.NextPageKey = pageKey;
            }
        }
